...
//			theGraphics.noStroke();
            ...
            for (int x = 0; x < _myCellX; x++) {
                for (int y = 0; y < _myCellY; y++) {
					...
					if(x>0){
						theGraphics.stroke(30,30,30);
						theGraphics.line((int) ((x) * stepX), 0, (int) ((x) * stepX), getHeight());
						theGraphics.noStroke();
					}

					if(y > 0){
						theGraphics.stroke(30,30,30);
						theGraphics.line(0, (int) ((y) * stepY), getWidth(), (int) (y * stepY));
						theGraphics.noStroke();
					}
            ...
            if (isInside()) {
                // TODO
                 //int x = (int) ((cp5.getPointer().getX() - x(position)) / stepX);
                 //int y = (int) ((cp5.getPointer().getY() - y(position)) / stepY);
